...
public class Order {
	...
	public Order(Integer id, String employee_id, String customer_id, String order_date, String shipped_date, String shipper_id,
			...
			String shipping_fee, String taxes, String payment_type, String paid_date, String notes, String tax_rate, String tax_status_id, 
			String status_id) {
	...
	public String getTax_status_id() {
		return tax_status_id;
	}

	public void setTax_status_id(String tax_status_id) {
		this.tax_status_id = tax_status_id;
	}
